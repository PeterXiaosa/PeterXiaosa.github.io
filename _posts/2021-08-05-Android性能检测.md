...
buildscript {
    ...
    dependencies {
        // ...
        classpath "com.github.PeterXiaosa.MethodTracer:plugin:1.0.5"
    }
}
```
...
dependencies {
    ...
    implementation 'com.github.PeterXiaosa.MethodTracer:monitor:1.0.5'
    implementation 'com.github.PeterXiaosa.MethodTracer:plugin:1.0.5'
}
